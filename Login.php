        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description">Login Customer</p>
              <form action="loginpelanggan_proses.php" method="post">
                  ...
                  <input name="tambah" id="login" class="btn btn-block login-btn mb-4" type="submit" value="Login">
                </form>
