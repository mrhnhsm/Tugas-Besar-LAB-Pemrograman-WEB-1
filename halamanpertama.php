    ...
    <a href="index.html" class="logo me-auto me-lg-0"><img src="img/logo.jpg" alt="" class="img-fluid"></a>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="Login.php">Login Customer</a></li>
          <li><a class="nav-link scrollto" href="loginadmin.php">Login Admin</a></li>
          <li><a class="nav-link scrollto" href="logoutusaha.php">Logout</a></li>
        </ul>
